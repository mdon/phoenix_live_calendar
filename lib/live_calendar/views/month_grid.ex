defmodule LiveCalendar.Views.MonthGrid do
  @moduledoc """
  ...
  def month_grid(assigns) do
    ...
    markers_by_date = LiveCalendar.DayMarker.group_by_date(assigns.day_markers, dates)
    ...
    if slot_data.slot_count == 0 do
      ...
      |> Enum.flat_map(fn idx ->
        case Map.get(slot_data.slots, idx) do
          ...
          event ->
            if LiveCalendar.Event.on_date?(event, day) do
