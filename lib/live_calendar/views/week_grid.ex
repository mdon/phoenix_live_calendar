defmodule LiveCalendar.Views.WeekGrid do
  @moduledoc """
  ...
  alias LiveCalendar.Components.{EventItem, TimeGutter}
  alias LiveCalendar.Event
  alias LiveCalendar.Utils.{DateHelpers, I18n, OverlapLayout, Safe, TimeSlots}
  ...
  - `business_hours` — List of `LiveCalendar.Availability` for highlighting
        ...
        <div class="flex-1 grid relative" style={"grid-template-columns: repeat(#{@col_count}, 1fr)"}>
          ...
          >
            ...
            <div
              ...
              style={"height: #{LiveCalendar.Utils.Safe.sanitize_css_dimension(@slot_height)}"}
  ...
  defp slot_business_class(date, slot_time, business_hours) do
    windows = LiveCalendar.Availability.windows_for_date(business_hours, date)

    is_business =
      Enum.any?(windows, fn w ->
        w.available and LiveCalendar.Availability.covers_time?(w, slot_time)
      end)
