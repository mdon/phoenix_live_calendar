defmodule LiveCalendar.Views.ResourceView do
  @moduledoc """
  ...
  alias LiveCalendar.Utils.TimeSlots
  ...
  - `resources` — List of `LiveCalendar.Resource` structs (one column each)
  - `events` — List of `LiveCalendar.Event` structs (linked via resource_id)
