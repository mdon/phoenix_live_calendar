defmodule LiveCalendar.Views.Timeline do
  @moduledoc """
  ...
  alias LiveCalendar.Components.EventItem
  alias LiveCalendar.Event
  alias LiveCalendar.Utils.{I18n, TimeSlots}
  ...
  - `resources` — List of `LiveCalendar.Resource` structs
  - `events` — List of `LiveCalendar.Event` structs (linked to resources via resource_id)
      ...
      <div class="inline-flex flex-col min-w-full">
        ...
        <div class="cal-timeline-header flex border-b border-base-200 sticky top-0 bg-base-100 z-10">
          <div
            ...
            style={"width: #{LiveCalendar.Utils.Safe.sanitize_css_dimension(@resource_width)}"}
          >
          </div>
          <div class="flex">
            <div
              ...
              style={"width: #{LiveCalendar.Utils.Safe.sanitize_css_dimension(@slot_width)}"}
            >
        ...
        >
          ...
          <div class="flex relative">
            <div
              ...
              style={"width: #{LiveCalendar.Utils.Safe.sanitize_css_dimension(@slot_width)}; min-height: 3rem;"}
