defmodule LiveCalendar.Event do
  @moduledoc """
  ...
  ## Examples
      ...
      # Minimal event
      %LiveCalendar.Event{id: "1", start: ~D[2026-04-01]}
  ...
  def duration_seconds(%__MODULE__{} = event) do
    ...
    case {start, end_time} do
      ...
      _ ->
        ...
        Logger.warning(
          "[LiveCalendar] Mismatched date types in duration_seconds for event #{inspect(event.id)}"
        )
