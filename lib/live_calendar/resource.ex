defmodule LiveCalendar.Resource do
  @moduledoc """
  ...
  ## Examples
      ...
      # Simple room
      %LiveCalendar.Resource{id: "room-a", title: "Conference Room A"}

      # Person with type
      %LiveCalendar.Resource{
        id: "dr-smith",
        title: "Dr. Smith",
        type: :person,
        color: "bg-accent"
      ...
      %LiveCalendar.Resource{id: "floor-1", title: "First Floor"}
      %LiveCalendar.Resource{id: "room-101", title: "Room 101", parent_id: "floor-1"}
  """
