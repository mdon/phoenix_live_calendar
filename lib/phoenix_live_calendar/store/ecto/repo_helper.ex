if Code.ensure_loaded?(Ecto) do
  defmodule PhoenixLiveCalendar.Store.Ecto.RepoHelper do
    @moduledoc """
    ...
    @spec repo() :: module()
    def repo do
      case Application.get_env(:phoenix_live_calendar, :repo) do
        nil ->
          raise """
          No Ecto repository configured for PhoenixLiveCalendar.
