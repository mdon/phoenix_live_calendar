if Code.ensure_loaded?(Ecto) do
  defmodule PhoenixLiveSchedule.Store.Ecto.EventStoreEcto do
    @moduledoc """
    Default Ecto implementation of `PhoenixLiveSchedule.Store.EventStore`.

    Uses `PhoenixLiveSchedule.Store.Ecto.EventSchema` and the configured Ecto repo.
    ...
    alias PhoenixLiveSchedule.Store.Ecto.{EventSchema, RepoHelper}
