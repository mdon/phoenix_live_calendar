if Code.ensure_loaded?(Ecto) do
  defmodule PhoenixLiveSchedule.Store.Ecto.RepoHelper do
    @moduledoc """
    ...
    @spec repo() :: module()
    def repo do
      case Application.get_env(:phoenix_live_schedule, :repo) do
        nil ->
          raise """
          No Ecto repository configured for PhoenixLiveSchedule.
