defmodule PhoenixLiveSchedule.Components.EventPopover do
  @moduledoc """
  ...
  alias PhoenixLiveSchedule.Utils.I18n
  ...
  """
  attr :event, PhoenixLiveSchedule.Event, default: nil
  ...
  attr :event, PhoenixLiveSchedule.Event, required: true
