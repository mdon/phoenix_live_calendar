defmodule PhoenixLiveSchedule.Event do
  @moduledoc """
  ...
  ## Examples
      ...
      # Minimal event
      %PhoenixLiveSchedule.Event{id: "1", start: ~D[2026-04-01]}
  ...
  def duration_seconds(%__MODULE__{} = event) do
    ...
    case {start, end_time} do
      ...
      _ ->
        ...
        Logger.warning(
          "[PhoenixLiveSchedule] Mismatched date types in duration_seconds for event #{inspect(event.id)}"
        )
