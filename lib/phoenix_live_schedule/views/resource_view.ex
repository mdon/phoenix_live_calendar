defmodule PhoenixLiveSchedule.Views.ResourceView do
  @moduledoc """
  ...
  - `resources` — List of `PhoenixLiveSchedule.Resource` structs (one column each)
  - `events` — List of `PhoenixLiveSchedule.Event` structs (linked via resource_id)
