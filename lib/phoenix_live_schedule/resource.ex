defmodule PhoenixLiveSchedule.Resource do
  @moduledoc """
  ...
  ## Examples
      ...
      # Simple room
      %PhoenixLiveSchedule.Resource{id: "room-a", title: "Conference Room A"}
      ...
      %PhoenixLiveSchedule.Resource{id: "floor-1", title: "First Floor"}
      %PhoenixLiveSchedule.Resource{id: "room-101", title: "Room 101", parent_id: "floor-1"}
  """
