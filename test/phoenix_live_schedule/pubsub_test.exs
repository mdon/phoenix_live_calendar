defmodule PhoenixLiveSchedule.PubSubTest do
  use ExUnit.Case, async: true

  alias PhoenixLiveSchedule.PubSub

  describe "topic/2" do
    test "generates basic topic" do
      assert PubSub.topic("my-calendar") == "phoenix_live_schedule:my-calendar"
    end
    ...
    test "without resource_id option" do
      assert PubSub.topic("cal-1", []) == "phoenix_live_schedule:cal-1"
    end
  end
