defmodule PhoenixLiveSchedule.Views.YearViewTest do
  use ExUnit.Case, async: true

  import Phoenix.LiveViewTest, only: [rendered_to_string: 1]
  import Phoenix.Component, only: [sigil_H: 2]
  import PhoenixLiveSchedule.Views.YearView
  ...
  describe "year_view/1" do
    ...
    test "renders event dot indicators" do
      events = [
        %PhoenixLiveSchedule.Event{id: "1", start: ~D[2026-06-15], title: "Event", all_day: true}
      ]
