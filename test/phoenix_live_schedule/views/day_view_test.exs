defmodule PhoenixLiveSchedule.Views.DayViewTest do
  use ExUnit.Case, async: true

  import Phoenix.LiveViewTest, only: [rendered_to_string: 1]
  import Phoenix.Component, only: [sigil_H: 2]
  import PhoenixLiveSchedule.Views.DayView
  ...
  describe "day_view/1" do
    ...
    test "renders with events" do
      event = %PhoenixLiveSchedule.Event{id: "1", start: ~U[2026-04-01 10:00:00Z], title: "Meeting"}
