defmodule PhoenixLiveSchedule.Views.NDayViewTest do
  use ExUnit.Case, async: true

  import Phoenix.LiveViewTest, only: [rendered_to_string: 1]
  import Phoenix.Component, only: [sigil_H: 2]
  import PhoenixLiveSchedule.Views.NDayView
  ...
  describe "n_day_view/1" do
    ...
    test "renders with events" do
      event = %PhoenixLiveSchedule.Event{id: "1", start: ~U[2026-04-02 10:00:00Z], title: "Meeting"}
