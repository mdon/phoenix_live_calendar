defmodule PhoenixLiveSchedule.Store.Ecto.EventSchemaTest do
  ...
  describe "to_event/1" do
    test "maps a timed schema to a PhoenixLiveSchedule.Event" do
      schema = %EventSchema{
        id: "e",
        title: "T",
      ...
      assert event.__struct__ == PhoenixLiveSchedule.Event
      assert event.id == "e"
