defmodule LiveCalendar.PubSubTest do
  use ExUnit.Case, async: true

  alias LiveCalendar.PubSub

  describe "topic/2" do
    test "generates basic topic" do
      assert PubSub.topic("my-calendar") == "live_calendar:my-calendar"
    end
    ...
    test "without resource_id option" do
      assert PubSub.topic("cal-1", []) == "live_calendar:cal-1"
    end
  end
